...
import (
	...
	"github.com/lab23/abstruse/server/api/badge"
	"github.com/lab23/abstruse/server/api/build"
	"github.com/lab23/abstruse/server/api/middlewares"
	"github.com/lab23/abstruse/server/api/provider"
	"github.com/lab23/abstruse/server/api/repo"
	"github.com/lab23/abstruse/server/api/setup"
	"github.com/lab23/abstruse/server/api/stats"
	"github.com/lab23/abstruse/server/api/system"
	"github.com/lab23/abstruse/server/api/team"
	"github.com/lab23/abstruse/server/api/user"
	"github.com/lab23/abstruse/server/api/webhook"
	"github.com/lab23/abstruse/server/api/worker"
	"github.com/lab23/abstruse/server/config"
	"github.com/lab23/abstruse/server/core"
	"github.com/lab23/abstruse/server/ui" // user interface files
